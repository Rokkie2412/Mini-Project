...
import type {ModalHelp} from "../components/pomodoro.type"

const HelpModal = ({HelpVisible, setHelpVisible}:ModalHelp): React.Node => {
  return (
      ...
      <KeyboardAvoidingView style={styles.mainContainer}>
        ...
        <View style={styles.TextContainer}>
          ...
          <View style={styles.textStruct}>
            ...
            <Text style={styles.text2}>
              Before use Doro Timer, you can set your timer that set for you in
              setting button
            </Text>
          </View>
          <View style={styles.textStruct}>
            ...
            <Text style={styles.text2}>
              To start timer, press play button, and to pause press pause
              button. Button will change every you press the button
            </Text>
          </View>
          <View style={styles.textStruct}>
            <Text style={styles.text1}>4.</Text>
            <Text style={styles.text2}>
              To stop timer, press stop button, timer will get reset to first
              condition
            </Text>
          </View>
          <View style={styles.textStruct}>
            ...
            <Text style={styles.text2}>
              When timer on you can't open setting, you must stop your timer
              first
            </Text>
          </View>
        </View>
